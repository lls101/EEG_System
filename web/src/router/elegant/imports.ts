...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  analysis_features: () => import("@/views/analysis/features/index.vue"),
  "apply-model_pd": () => import("@/views/apply-model/pd/index.vue"),
  "deep-learning_dataset": () => import("@/views/deep-learning/dataset/index.vue"),
  "deep-learning_evaluation": () => import("@/views/deep-learning/evaluation/index.vue"),
  "deep-learning_inference": () => import("@/views/deep-learning/inference/index.vue"),
  "deep-learning_model-manage": () => import("@/views/deep-learning/model-manage/index.vue"),
  "deep-learning_train-config": () => import("@/views/deep-learning/train-config/index.vue"),
  "deep-learning_train-monitor": () => import("@/views/deep-learning/train-monitor/index.vue"),
  "deep-learning_train-tasks": () => import("@/views/deep-learning/train-tasks/index.vue"),
  "demo-route_child": () => import("@/views/demo-route/child/index.vue"),
  eegfile_filemanage: () => import("@/views/eegfile/filemanage/index.vue"),
  eegfile_upload: () => import("@/views/eegfile/upload/index.vue"),
  ...
  plugin_charts_echartscopy: () => import("@/views/plugin/charts/echartscopy/index.vue"),
  plugin_charts_vchart: () => import("@/views/plugin/charts/vchart/index.vue"),
  plugin_charts_vchartcopy: () => import("@/views/plugin/charts/vchartcopy/index.vue"),
  ...
  preprocess_ica: () => import("@/views/preprocess/ica/index.vue"),
  "preprocess_preprocess-basic": () => import("@/views/preprocess/preprocess-basic/index.vue"),
  preprocess_wavelet: () => import("@/views/preprocess/wavelet/index.vue"),
  test_plotlydemo: () => import("@/views/test/plotlydemo/index.vue"),
